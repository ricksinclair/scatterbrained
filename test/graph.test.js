...
describe('smartLabel', () => {
  it('shows the basename for path-like names so siblings stop colliding', () => {
    expect(smartLabel('Worker Cooperatives/states/alabama.md', 26)).toBe('alabama.md');
    expect(smartLabel('Worker Cooperatives/states/alabama.md', 26))
      .not.toBe(smartLabel('Worker Cooperatives/states/wyoming.md', 26));   // distinguishable now
  });
