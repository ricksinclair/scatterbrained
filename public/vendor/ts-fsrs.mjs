// ts-fsrs v5.4.1 — vendored ESM bundle (MIT), github.com/open-spaced-repetition/ts-fsrs
// The Free Spaced Repetition Scheduler. Vendored offline like force-graph/marked —
// the studio stays zero-runtime-dependency. Re-vendor: npm i -D ts-fsrs && cp dist/index.mjs here (keep this header).
